//
//  AIRecommendIngredientsViewController.swift
//  Untitled
//
...
class AIRecommendIngredientsViewController: UIViewController {
...
extension AIRecommendIngredientsViewController: UITableViewDataSource, UITableViewDelegate {
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return aiVitaminNames[vitaminIndex].count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameLabel.text = aiVitaminNames[vitaminIndex][indexPath.row]
        cell.contentLabel.text = "\(aiVitaminValues[vitaminIndex][indexPath.row])(mg)"
