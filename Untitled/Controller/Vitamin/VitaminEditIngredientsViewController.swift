//
//  VitaminEditIngredientsViewController.swift
//  Untitled
//
...
class VitaminEditIngredientsViewController: UIViewController {
...
extension VitaminEditIngredientsViewController: UITableViewDataSource, UITableViewDelegate {
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return vitaminNames[vitaminIndex].count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameLabel.text = vitaminNames[vitaminIndex][indexPath.row]
        cell.contentLabel.text = "\(vitaminValues[vitaminIndex][indexPath.row])(mg)"
