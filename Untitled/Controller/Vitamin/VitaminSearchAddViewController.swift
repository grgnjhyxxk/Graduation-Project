//
//  VitaminSearchAddViewController.swift
//  Untitled
//
...
class VitaminSearchAddViewController: UIViewController {
    ...
    private func ingredientsNameConcatenated() -> String {
        ...
        for item in vitaminSearchNames[0] {
            names.append(item)
        }
    ...
    @objc func addButtonAction() {
        if vitaminNameTextFieldText != "" && perdayTextFieldText != "" && vitaminImage.image != nil {
            ...
            vitaminSearchImageDataPost() { success in
                if success {
                    sendRequestWithJSONPayloadSearch() { success in
                        if success {
                            vitaminBasicDataListInit()
                            ingredientsCellDataListInit()
    ...
    func repeatDaysButtonAction() {
        ...
        let rootViewController = VitaminSearchIngredientsViewController()
        show(rootViewController, sender: nil)
    }
}

extension VitaminSearchAddViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.nameTextField.text = userVitaminSearchDataList[0].prod_name
//            cell.nameTextField.isEnabled = false
        ...
        case 2:
            ...
            cell.dosageTextField.text = "\(userVitaminSearchDataList[0].intake_per_day)"
//            cell.nameTextField.isEnabled = false
        default:
            break
        }
...
extension VitaminSearchAddViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
